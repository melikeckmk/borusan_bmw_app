...
import 'diger.dart';
class yetkili_Servisler extends StatefulWidget {
  const yetkili_Servisler({Key? key}) : super(key: key);

  @override
  State<yetkili_Servisler> createState() => _yetkili_ServislerState();
}

class _yetkili_ServislerState extends State<yetkili_Servisler> {
  ...
  Set<Marker> _createMarkers() {
    return {
      Marker(
        ...
        position: LatLng(40.4048342, 29.0828417),
