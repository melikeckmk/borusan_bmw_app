...
import 'diger.dart';
class yetkili_Saticilar extends StatefulWidget {
  const yetkili_Saticilar({Key? key}) : super(key: key);

  @override
  State<yetkili_Saticilar> createState() => _yetkili_SaticilarState();
}

class _yetkili_SaticilarState extends State<yetkili_Saticilar> {
  ...
  Set<Marker> _createMarkers() {
    return {
      Marker(
        ...
        position: LatLng(40.2121598,28.9226644),
